...
function register_acf_blocks() {
    if( function_exists('acf_register_block_type') ) {
        acf_register_block_type(array(
            ...
            'description'       => __('A block to display client logos in a grid layout.'), 
            'render_template'   => get_template_directory() . '/template-parts/blocks/logos.php', 
            'category'          => 'formatting', 
            'icon'              => 'screenoptions', 
            'keywords'          => array( 'logos', 'clients', 'grid' ), 
            'enqueue_style'     => get_template_directory_uri() . '/template-parts/components/css/logos.css', 
            'supports'          => array(
                'align' => false, 
                'anchor' => true, 
                'mode' => 'auto',
...
function enqueue_team_member_styles() {
    ...
    if ( is_singular( 'team' ) ) {
        wp_enqueue_style(
            'team-member-style', 
            get_template_directory_uri() . '/template-parts/components/css/team-member.css', // Path for singular
            array(), 
            '1.0', 
            'all'
        );
    ...
    if ( is_post_type_archive( 'team' ) ) {
        wp_enqueue_style(
            'team-archive-style', 
            get_template_directory_uri() . '/template-parts/components/css/team-archive.css', // Path for archive
            array(), 
            '1.0', 
            'all'
        );
